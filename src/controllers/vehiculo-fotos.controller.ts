...
export class VehiculoFotosController {
  ...
  async find(
    ...
    return this.vehiculoRepository.vehiculotienefotos(id).find(filter);
  }
  ...
  async create(
    ...
    return this.vehiculoRepository.vehiculotienefotos(id).create(fotos);
  }
  ...
  async patch(
    ...
    return this.vehiculoRepository.vehiculotienefotos(id).patch(fotos, where);
  }
  ...
  async delete(
    ...
    return this.vehiculoRepository.vehiculotienefotos(id).delete(where);
  }
}
